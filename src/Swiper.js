  ...
  _getPanResponderCallbacks() {
    return {
      ...
      onMoveShouldSetPanResponderCapture: (e, gestureState) => {
        ...
        const thrasholdOvercomed = (vertical ? dy : dx) > minDistanceToCapture;
        const allow = thrasholdOvercomed && (vertical ? dy > dx : dx > dy);

        if (this.currentGestureAllowed && thrasholdOvercomed) {
